...
OWNER ='300703706431881216'
TOKEN='Njg1MDkzMTY0Mzk4MTQ5NjMz.G6KpCr.XuBbqhQnyK7bGKyePRmIMbXlbEwF3BQQhafYTU'
...
async def about(ctx):
    embed = await embedPackaging.packEmbed(
        title = "About",
        description = "Bot Written by Nik",
        embedType = "info",
        command = "about",
        fields = [
            {"name": "Support Server", "value": "https://discord.gg/UEzF2BUw", "inline": False},
        ]
    )
    await ctx.respond(embed = embed)
